    ...
    <table cellspacing="0" cellpadding="0" id="tableContainer" border="0" width="100%" style="margin-top: 20px;">
                ...
                @foreach ($detalleConsolidado as $val)
                    ...
                    <tr>
                        ...
                        <td style="width: 15%" valign="top">
                            <div id="detalle">{{ $val->shipper_json ? $shipper_json->nombre : $val->nom_ship }}
                            </div>
                            <div id="detalle">{{ $val->shipper_json ? $shipper_json->direccion : $val->dir_ship }}
                            </div>
                            <div id="detalle">{{ $val->shipper_json ? $shipper_json->telefono : $val->tel_ship }}
                            </div>
                        ...
                        <td id="detalle" style="width: 22%" valign="top">
                            <div id="detalle">{{ $val->consignee_json ? $consignee_json->nombre : $val->nom_cons }}
                            </div>
                            <div id="detalle">
                                {{ $val->consignee_json ? $consignee_json->direccion : $val->dir_cons }}</div>
                            <div id="detalle">
                                {{ $val->consignee_json ? $consignee_json->telefono : $val->tel_cons }}</div>
                    ...
                    <tr>
                        <th colspan="7">
                            <div style="font-size:1px;margin-top:6px;margin-bottom: 6px; background-color: #ccc">&nbsp;
                            </div>
                        </th>
                    </tr>
                    <?php
        ...
        <tfoot>
            <tr>
                ...
                <th>
                    <div style="margin-top:8px;text-align: center;font-size: 14px;color:#1d1d1e;">{{ $totPiezas }}
                    </div>
                </th>
                <th>
                    <div style="margin-top:5px;text-align: center;font-size: 14px;color:#1d1d1e;">{{ $peso }}
                        Lb</div>
                </th>
                <th>
                    <div style="margin-top:5px;text-align: center;font-size: 14px;color:#1d1d1e;">{{ ceil($vol) }}
                        Lb</div>
                </th>
            </tr>
            <tr>
