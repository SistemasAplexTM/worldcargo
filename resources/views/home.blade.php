                ...
                <div class="col-lg-3">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="stat-percent font-bold text-success">@{{ web }} <i class="fa fa-user"></i></div>
                            <small>Registros Mes Pagina</small>
                            <br>
                            <div class="stat-percent font-bold text-success">@{{ sistem }} <i class="fa fa-user"></i></div>
